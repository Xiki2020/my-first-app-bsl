    ...
    <button class="nav-app__btn" @click="$router.push({ name: 'HomePage' })">
      ...
      >
        <path
          ...
          :fill="$route.name == 'HomePage' ? '#4a5562' : '#97ADB6'"
        />
    ...
    >
      ...
      >
        <path
          ...
          :fill="$route.name == 'WishListPage' ? '#4a5562' : '#97ADB6'"
        />
      </svg>
    </button>
    <button class="nav-app__btn" @click="$router.push({ name: 'CartPage' })">
      ...
      >
        <path
          ...
          :fill="$route.name == 'CartPage' ? '#4a5562' : '#97ADB6'"
        />
      </svg>
    </button>
    ...
    <button class="nav-app__btn" @click="exit">
      ...
      >
        <path
          ...
          :fill="$route.name == 'PersonalAreaPage' ? '#4a5562' : '#97ADB6'"
        />
      </svg>
    </button>
  </nav>
